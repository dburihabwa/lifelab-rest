 ...
 */
app.controller('AppointmentCtrl', ['$rootScope', '$scope', '$stateParams', '$compile', 'Patients', 'uiCalendarConfig', function ($rootScope, $scope, $stateParams, $compile, Patients, uiCalendarConfig) {
